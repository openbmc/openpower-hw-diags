...
should be able to concatinate the devtree path of the chip and the relative
...
This will request to callout all parts associated with a bus. Note that bus
callouts have a very specific callout priority. Therefore, the `priority`
keyword is not defined like with other callouts.
