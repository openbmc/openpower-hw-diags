                     ...
                     libhei::Signature& o_rootCause)
{
    ...
    // attentions.
    // Look for any unit checkstop attentions that have been identified as a
    // potential root cause of a system checkstop attention. These would include
    // any attention that would generate an SUE.
    ...
    if (!list.empty())
    {
        ...
        //       remaining list (recoverable, unit checkstop, andthen system
