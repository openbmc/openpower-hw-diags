...
//  - The isolation data object containing the list of signatures found during
//    error isolation.
//  - The service data object containing service actions and FFDC for the root
//    cause attention.
using PluginFunction =
    std::function<void(unsigned int, const libhei::Chip&,
                       const libhei::IsolationData&, ServiceData&)>;
...
#define PLUGIN_DEFINE(CHIP, NAME) __PLUGIN_DEFINE(CHIP, NAME, NAME)
