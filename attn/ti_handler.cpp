                         ...
                         TiDataArea* i_tiDataArea)
{
    ...
    i_map["0x00 TI Area Valid:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->tiAreaValid);
    i_map["0x01 Command:"] = fmt::format("{:02x}", (int)i_tiDataArea->command);
    i_map["0x02 Num. Data Bytes:"] =
        fmt::format("{:04x}", be16toh(i_tiDataArea->numDataBytes));
    i_map["0x04 Reserved:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->reserved1);
    i_map["0x06 HWDump Type:"] =
        fmt::format("{:04x}", be16toh(i_tiDataArea->hardwareDumpType));
    i_map["0x08 SRC Format:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->srcFormat);
    i_map["0x09 SRC Flags:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->srcFlags);
    i_map["0x0a Num. ASCII Words:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->numAsciiWords);
    i_map["0x0b Num. Hex Words:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->numHexWords);
    ...
    i_map["0x50 Location:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->location);
    i_map["0x51 Code Sections:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->codeSection);
    i_map["0x52 Additional Size:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->additionalSize);
    i_map["0x53 Additional Data:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->andData);
}
                   ...
                   TiDataArea* i_tiDataArea)
{
    ...
    i_map["0x05 HB_Term. Type:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->hbTerminateType);
    i_map["0x0c HB Dump Flag:"] =
        fmt::format("{:02x}", (int)i_tiDataArea->hbDumpFlag);
    i_map["0x0d Source:"] = fmt::format("{:02x}", (int)i_tiDataArea->source);
