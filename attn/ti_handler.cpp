...
int tiHandler(TiDataArea* i_tiDataArea)
{
    ...
    {
        // HB TI Logic: Only hostboot fills in hb_terminate_type and source.
        // Additionally, PHYP should fill in srcFormat field.
    ...
    {
        // TI data was not available, assume PHYP TI. When support for querying
        // host state is available we may be able to make a more informed
        // decision here.
        handlePhypTi(i_tiDataArea);
    }
