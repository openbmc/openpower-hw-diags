...
class BitString
{
  ...
  public: // functions
     ...
     *          return nullptr. */
     packed_buffer * getBufAddr() const { return reinterpret_cast<packed_buffer *>(iv_bufAddr); }
                            ...
                            uint32_t   i_absPos ) const
{
    ...
    return reinterpret_cast<packed_buffer *>(iv_bufAddr) + ((i_absPos + iv_offset) / MINBITS);
}
